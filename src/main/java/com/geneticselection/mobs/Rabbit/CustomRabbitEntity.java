...
public class CustomRabbitEntity extends RabbitEntity implements AttributeCarrier {
    ...
    public CustomRabbitEntity(EntityType<? extends RabbitEntity> entityType, World world) {
        ...
        if (this.mobAttributes == null) {
            ...
            this.mobAttributes = new MobAttributes(speed, health, energy, Optional.of(meat), Optional.empty(), Optional.empty(), Optional.of(hide), Optional.empty(), Optional.empty());
            this.tickAge = 0;
        }
