...
public class ModEntities{
    ...
    public static final EntityType<CustomSquidEntity> CUSTOM_SQUID = Registry.register(
            Registries.ENTITY_TYPE,
            Identifier.of(GeneticSelection.MOD_ID, "custom_squid"),
            FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, CustomSquidEntity::new)
                    .dimensions(EntityDimensions.fixed(0.6F, 1.95F))
                    .build()
    );
}
